...
/**
 * Class SimpleWaveValidatorTest
 * @package WavesInterpreter\Tests\Validator
 */
class SimpleWaveValidatorTest extends \PHPUnit_Framework_TestCase
{

    /** @var  SimpleWaveValidator */
    protected $validator;

    public function setUp(){
        $this->validator = new SimpleWaveValidator();
    }
    /**
    ...
    {
        $this->validator->validate(new ComplexWave(new SimplePointCollection()));
    }


    public function testEmptyWave()
    {
        $wave = new SimpleWave(new SimplePointCollection());
    ...
    {
        $wave = new SimpleWave($collectionValid);
        $this->assertTrue($this->validator->validate($wave));
    }
